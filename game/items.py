...
ITEMS = {
    ...
    "文字狱": {"desc": "纵横飞花令专用：清除场上所有指定汉字及其周围一圈（例：/诗词道具 文字狱 春）", "scene": "flower"},
    "红杏出墙": {"desc": "纵横飞花令专用：你的下一句诗句可以无视棋盘边界（超出部分不显示）", "scene": "flower"},
}

# 各类型掉落池（D1 默认）
VERSE_DROP_POOL = ["火眼金睛", "三仙归洞", "定仙游", "仙人指路", "探囊取物", "招灾", "解难", "文字狱", "红杏出墙"]
